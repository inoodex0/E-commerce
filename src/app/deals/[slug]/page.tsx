  ...
  return (
    <main className="min-h-screen bg-[#FBF8F3] px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#E8852A] transition-colors hover:text-[#171412]"
        >
          <ArrowLeft size={16} /> Back to Home
        </Link>

        <div className="mt-6 border-b border-[#E7E1D8] pb-6">
          <div className="flex items-center gap-2 text-[#E8852A]">
            <Tag size={16} />
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-auto flex items-center justify-between pt-4">
                  <div className="flex items-baseline gap-2">
                    <span className="text-sm font-bold text-[#E8852A]">{item.dealPrice}</span>
                    <span className="text-xs text-[#6B6560] line-through">{item.originalPrice}</span>
                  </div>
                  <button className="flex items-center gap-1.5 border border-[#171412] bg-[#171412] px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#E8852A] hover:border-[#E8852A]">
