...
const products = [
  { id: 1, name: "Classic Leather Watch", price: 3850, oldPrice: 4500, image: "/images/products/watch-1.avif", category: "Watches", badge: "Best Selling" },
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-square w-full overflow-hidden bg-[#FAFAFA]">
                ...
                />
                {product.badge && (
                  <span className="absolute left-2 top-2 rounded bg-[#E8852A] px-2 py-0.5 text-[8px] font-bold text-white sm:text-[9px]">
                    {product.badge}
                  </span>
                )}
              </div>
